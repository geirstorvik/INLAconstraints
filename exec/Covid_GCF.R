...
#INLA calls
covid.goicoa.proj=inla(baseformula.proj, family = "poisson",data =df,num.threads ="6:2",
                       inla.mode="experimental",
                         control.fixed = list(
                           prec.intercept =0.01),verbose=T,control.inla=list(strategy="gaussian" ))
#saveRDS(covid.goicoa.proj,file="covid.goicoa.proj.RDS")
  
covid.goicoa=inla(baseformula, family = "poisson",data =df,num.threads ="6:2",inla.mode="experimental",
                    control.fixed = list(
                      prec.intercept =0.01),verbose=T,control.inla=list(strategy="gaussian" ))
#saveRDS(covid.goicoa,file="covid.goicoa.RDS")
...
>>>>>>> a28a23e (Update Covid_GCF from MI)
